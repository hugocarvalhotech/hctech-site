    ...
    <footer className="bg-[#F5F6F7] text-[#0E0E0E] border-t border-gray-200">
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex space-x-3">
                ...
                {/* Ícone WhatsApp */}
                <a href="https://wa.me/5581995757805" target="_blank" rel="noopener noreferrer" className="text-[#0E0E0E] hover:text-[#0672CB] transition-colors" aria-label="WhatsApp">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.52 3.48a11.83 11.83 0 00-16.76 0 11.71 11.71 0 00-3.45 8.28 11.72 11.72 0 002.19 6.49L2 22l4.71-1.24a11.71 11.71 0 006.52 2.2c2.75 0 5.37-1.07 7.32-3.03a11.83 11.83 0 000-16.46zm-8.06 15.06a9.18 9.18 0 01-4.65-1.28l-.33-.2-2.79.74.74-2.72-.22-.34a9.3 9.3 0 0115.8-7.53 9.27 9.27 0 01-10.45 10.33zm5.52-6.34c-.3-.15-1.77-.87-2.05-.97-.28-.1-.48-.15-.68.15s-.78.97-.96 1.17c-.18.2-.35.22-.65.07a6.61 6.61 0 01-1.94-1.2 7.33 7.33 0 01-1.36-1.69c-.15-.25 0-.38.11-.53.12-.13.3-.34.45-.51a1.89 1.89 0 00.28-.47.67.67 0 000-.48c-.07-.16-.68-1.64-.94-2.25-.24-.59-.48-.51-.68-.52-.17 0-.37 0-.57 0s-.52.07-.79.38a3.3 3.3 0 00-1 1.23 4.36 4.36 0 001.17 5.48 7.53 7.53 0 004.56 2.57 3.49 3.49 0 002.48-.88 2.85 2.85 0 00.84-1.28c.07-.15.06-.27 0-.37-.08-.13-.3-.21-.6-.36z" />
                  </svg>
                </a>
              </div>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          © 2025 HC Tech. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
