    ...
    <footer className="bg-[#F5F6F7] text-[#0E0E0E] border-t border-gray-200">
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex space-x-3">
                <a href="#" className="text-[#0E0E0E] hover:text-[#0672CB] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/hctechbr/" className="text-[#0E0E0E] hover:text-[#0672CB] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-300 mt-8 pt-6 text-center">
          <p>&copy; {new Date().getFullYear()} HC Tech. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
